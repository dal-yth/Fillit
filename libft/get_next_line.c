...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/11/21 13:04:37 by jmakela           #+#    #+#             */
/*   Updated: 2019/11/21 13:04:37 by jmakela          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
** Strdup the remainder of arr[fd] into temp. Index + 1 is used so we skip the \n.
...
** Returns -1 for error, 1 for line read successfully or 0 for completed reading.
** Uses static two dimensional char array to handle up to 10000 different fds.
** While there is stuff left to read, gnl strjoins read chars (buf) and arr[fd],
